...
export declare class DwDropdownService {
    private overlay;
    private document;
    private zone;
    protected instance: DwDropdownContextComponent;
    private overlayRef;
    private locatePoint;
    ...
    create($event: MouseEvent, template: TemplateRef<void>): DwDropdownContextComponent;
    close(): void;
}
