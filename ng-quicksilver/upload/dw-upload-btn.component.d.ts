...
export declare class DwUploadBtnComponent implements OnInit, OnChanges, OnDestroy {
    private http;
    private el;
    ...
    private prefixCls;
    setClassMap(): void;
    constructor(http: HttpClient, el: ElementRef, updateHostClassService: DwUpdateHostClassService, cd: ChangeDetectorRef);
    ngOnInit(): void;
    ngOnChanges(changes: {
