# ng-quicksilver Schematics

## Schematics

### ng-add

添加 ng-quicksilver 与它的依赖，并根据需要自动配置。

- 添加 ng-quicksilver 到 `package.json`
...
```bash
$ ng add ng-quicksilver [--locale=zh-CN] [--theme] [--skipPackageJson]
```
...
4. `cd schematic-debug && npm link ng-quicksilver`
...
4. `ng g ng-quicksilver:[schematic]` 运行 schematic
