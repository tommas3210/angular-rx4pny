...
export declare const DW_MENTION_TRIGGER_ACCESSOR: ExistingProvider;
export declare class DwMentionTriggerDirective implements ControlValueAccessor, OnDestroy {
    el: ElementRef;
