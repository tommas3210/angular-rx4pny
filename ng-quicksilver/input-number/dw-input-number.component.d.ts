...
export declare class DwInputNumberComponent implements ControlValueAccessor, AfterViewInit {
    private elementRef;
    private renderer;
    private isInit;
    private _disabled;
    ...
    dwSize: 'small' | 'default' | 'large';
    dwMin: number;
    dwMax: number;
    dwParser: (value: any) => any;
    dwPrecision: number;
    ...
    dwDisabled: boolean;
    dwStep: number;
    dwFormatter: (value: number) => string | number;
