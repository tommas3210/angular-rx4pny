...
export declare class DwScrollService {
    private doc;
    constructor(doc: any);
    /** 设置 `el` 滚动条位置 */
...
export declare function SCROLL_SERVICE_PROVIDER_FACTORY(doc: Document, scrollService: DwScrollService): DwScrollService;
