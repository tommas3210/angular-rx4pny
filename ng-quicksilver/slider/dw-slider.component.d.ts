...
export declare class DwSliderComponent implements ControlValueAccessor, OnInit, OnChanges, OnDestroy {
    private utils;
    dwDebugId: number | string;
    dwDisabled: boolean;
    dwStep: number;
    dwMarks: Marks;
    dwMin: number;
    dwMax: number;
    dwDefaultValue: SliderValue;
    dwTipFormatter: (value: number) => string;
    dwOnAfterChange: EventEmitter<number | number[]>;
    dwVertical: boolean;
    dwRange: boolean;
    dwDots: boolean;
    dwIncluded: boolean;
    ...
    constructor(utils: DwSliderService);
    ngOnInit(): void;
