...
export class OrderService {
   ...
   * @param {IDemo1OrderSearchField} searchParam
   * @param {IDemo1OrderSortSet[]} sortSet
   ...
   * 修改訂單
   *
   * @param {OrderMasterModel} master
   * @param {OrderProductInfo[]} detail
  ...
  public modifyOrder(master: OrderMasterModel, detail: OrderProductInfo[]): Observable<any> {
    ...
    const masterStr = {
      ...master,
      orderDate: moment(master.orderDate).format(this.dwDateFormat)
    };
