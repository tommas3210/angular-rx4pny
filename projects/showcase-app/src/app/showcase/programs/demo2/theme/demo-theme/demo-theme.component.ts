...
import * as themeBaseCode from '!raw-loader!./theme-base/theme-base.component.ts';
import { ThemeButtonTemplateComponent } from './theme-button-template/theme-button.template';
import * as themeTmpCode from '!raw-loader!./theme-button-template/theme-button.template.ts';
import { ThemePopComponent } from './theme-pop/theme-pop.component';
import * as themePopCode from '!raw-loader!./theme-pop/theme-pop.component.ts';
